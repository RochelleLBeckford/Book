...
### Create a Books Demo with Session
...
# Data Persistence
spring.datasource.url=jdbc:mysql://localhost:3306/<!-- <<WHATEVER_YOUR_SCHEMA_NAME>> -->books
...
-->
- [] add controller [MainController.java](src/main/java/com/rochelle/books/controllers/MainController.java)
# Books
